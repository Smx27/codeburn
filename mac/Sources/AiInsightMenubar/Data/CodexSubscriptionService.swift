...
enum CodexSubscriptionService {
    ...
    private static let usageBlockedUntilKey = "aiinsight.codex.usage.blockedUntil"
    ...
    private static func fetchWithToken(_ token: String, allowOne401Recovery: Bool) async throws -> CodexUsage {
        ...
        request.setValue("AiInsight", forHTTPHeaderField: "User-Agent")
        ...
        case 200:
            ...
            do {
                ...
                NSLog("AiInsight: codex usage decode failed: %@", String(describing: error))
