    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("Connect Claude subscription")
                .font(.system(size: 12, weight: .semibold))
                .foregroundStyle(.primary)
            Text("AiInsight will read your Claude Code credentials once. macOS will ask permission. After that, the live quota bar shows next to the Claude tab and updates automatically.")
                .font(.system(size: 10.5))
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .frame(maxWidth: 280)
