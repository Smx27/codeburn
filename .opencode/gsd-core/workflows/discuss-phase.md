...
<required_reading>
@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/domain-probes.md
@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/gate-prompts.md
@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
