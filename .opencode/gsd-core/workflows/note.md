...
- **Global scope**: `/home/priya/Documents/Github/Ai/aiinsight/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/priya/Documents/Github/Ai/aiinsight/.opencode/notes/`)
...
2. Glob `/home/priya/Documents/Github/Ai/aiinsight/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/priya/Documents/Github/Ai/aiinsight/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/priya/Documents/Github/Ai/aiinsight/.opencode/notes/` — works in any directory
