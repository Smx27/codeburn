...
```
Agent(
  prompt="Read /home/priya/Documents/Github/Ai/aiinsight/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/templates/VALIDATION.md`
