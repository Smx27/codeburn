...
@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/context-budget.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       <execution_context>
       @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/workflows/execute-plan.md
       @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/templates/summary.md
       @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/checkpoints.md
       @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/tdd.md
       @/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/references/executor-examples.md'}
       </execution_context>
...
Read and follow `/home/priya/Documents/Github/Ai/aiinsight/.opencode/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
