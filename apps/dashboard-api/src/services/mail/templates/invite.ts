...
export function invite(props: InviteProps): EmailTemplate {
  const subject = `You've been invited to join ${props.organizationName} on Niriksh`;
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#111827;border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);">
        <tr>
          <td style="background:linear-gradient(135deg,#77FF47,#22C55E);padding:40px;text-align:center;">
            <h1 style="color:#0a0f1a;margin:0;font-size:28px;font-weight:700;letter-spacing:-0.5px;">You're Invited!</h1>
          </td>
        </tr>
        <tr>
          <td style="padding:40px;">
            ...
            <p style="color:#9ca3af;font-size:16px;line-height:1.6;margin:0 0 24px;">
              ...
              <strong style="color:#ffffff;">${props.organizationName}</strong> on Niriksh.
            </p>
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
              <tr>
                <td style="padding:16px;background-color:#0a0f1a;border-radius:8px;border:1px solid rgba(255,255,255,0.06);">
                  <p style="color:#6b7280;font-size:13px;margin:0 0 4px;">Your role</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center">
                  <a href="${props.invitationUrl}" style="display:inline-block;background-color:#77FF47;color:#0a0f1a;font-size:16px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:8px;">Accept Invitation</a>
                </td>
              </tr>
            </table>
...
${props.inviterName} has invited you to join "${props.organizationName}" on Niriksh.
