...
export function passwordReset(props: PasswordResetProps): EmailTemplate {
  const subject = 'Reset your password - AIInsight';
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center">
                  <a href="${props.resetUrl}" style="display:inline-block;background-color:#6366f1;color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:8px;">Reset Password</a>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:24px;">
              <tr>
                <td style="padding:16px;background-color:#0f172a;border-radius:8px;border-left:3px solid #ef4444;">
